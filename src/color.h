...
static constexpr auto ORANGE = linalg::vec<float, 3>(170.0f / 255.0f, 116.0f / 255.0f, 57.0f / 255.0f);
static constexpr auto GREY = linalg::vec<float, 3>(82.0f / 255.0f, 82.0f / 255.0f, 82.0f / 255.0f);
